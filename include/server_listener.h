...
class server_listener : public lnl::net_event_listener {
public:
    server_listener() : owner(nullptr){};

    void setOwner(UDPServer* owner);
    ...
    void on_network_latency_update(shared_ptr<lnl::net_peer>& peer, int latency);
